...
const API_CONFIG = {
    ...
    LC79TX: 'https://wtx.tele68.com/v1/tx/lite-sessions'
};
...
app.listen(port, () => {
    console.log(`=========================================`);
    console.log(`🚀 TIENDUNGDEVTai Xiu API đang chạy!`);
    ...
    console.log(`   GET /lc79tx   -Dự đoán LC79TX (real-time)`);
    console.log(`   GET /sunwin/cached - Dự đoán Sunwin (cached)`);
    console.log(`   GET /lc79/cached   - Dự đoán LC79 (cached)`);
    console.log(`   GET /lc79tx/cached  -Dự đoán LC79TX (cached)`);
    console.log(`=========================================`);
});
